...
def nuscenes_data_prep(root_path, version, dataset_name, max_sweeps=10, truncate_to=None):
    nu_ds.create_nuscenes_infos(root_path, version=version, max_sweeps=max_sweeps, truncate_to=truncate_to)
